...
public class HeaderParserTests
{
   private static readonly byte[] PsdHeader =
      Encoding.Latin1.GetBytes("8BPS\x00\x01\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x96\x00\x00\x00\xfa\x00\x08\x00\x03");
   private static readonly byte[] PsdHeaderWithDimensionsTooLarge =
      Encoding.Latin1.GetBytes("8BPS\x00\x01\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\xc3\x50\x00\x00\xc3\x50\x00\x08\x00\x03");
   private static readonly byte[] PsbHeader =
      Encoding.Latin1.GetBytes("8BPS\x00\x02\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\xc3\x50\x00\x00\xc3\x50\x00\x08\x00\x03");
   private static readonly byte[] PsbHeaderWithDimensionsTooLarge =
      Encoding.Latin1.GetBytes("8BPS\x00\x02\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x06\xdd\xd0\x00\x00\x06\xdd\xd0\x00\x03");
   ...
   {
      var stream = new MemoryStream(Encoding.Latin1.GetBytes("PNG\x00\x01\x00"));
      var reader = new BigEndianReader(stream);
      var parseContext = new ParseContext(reader, new PsdLoadOptions());
